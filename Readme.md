...
* **Document Loading:** The **Tanzu GemFire 10.2 technical manual** is read and converted into raw text.
...
* **Role Creation (Prompt Engineering):** A **system role/prompt** is created for the **gemma3n chat model** to establish it as a **Tanzu GemFire 10.2 expert** that must operate within a strict **contextual boundary**.
